...
Найпростіший спосіб запустити проєкт разом із базою даних PostgreSQL — використати Docker.

# Створіть файл зі змінними оточення
`cp .env.example .env.local`

# Запустіть застосунок та базу даних у фоновому режимі
`docker compose up -d`

Застосунок буде доступний за адресою: http://localhost:3000
База даних буде доступна на порту `5432`.
Щоб зупинити контейнери, виконайте: `docker compose down`.

## Локальний запуск (Без Docker)
Якщо ви хочете запустити Node.js локально (база даних все одно потребуватиме окремого налаштування):
